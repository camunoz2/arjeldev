...
summary: "A TODO app with a twist, it divides the day in 4 moments, it has persistent data and is user binded trought google login, it has protected routes, and its database is in a REDIS list trought upstash."
cardColor: "#aa5b8f"
